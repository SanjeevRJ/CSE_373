...
public class ArrayDictionary<K, V> implements IDictionary<K, V> {
    ...
    public Iterator<KVPair<K, V>> iterator() {
        return new ArrayDictionaryIterator<>(this.pairs, this.curSize);
    }
    ...
    private static class ArrayDictionaryIterator<K, V> implements Iterator<KVPair<K, V>> {
        ...
        public ArrayDictionaryIterator(Pair<K, V>[] pairs, int curSize) {
            this.pairs = pairs;
        ...
        public KVPair<K, V> next() {
            ...
            KVPair<K, V> retKV = new KVPair<>(this.pairs[curIndex].key, this.pairs[curIndex].value);
            curIndex++;
            return retKV;
        }
    }
